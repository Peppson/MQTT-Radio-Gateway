...
#include "Captured_RF_Remote_Codes.h"


// User Controlled
#define SERIAL_ON 1                                 // Serial On/Off
#define This_dev_address  0                         // NRF24 device address                                        
#define Radio_channel  124                          // NRF24 radio channel
#define Radio_output RF24_PA_MAX                    // NRF24 output level: RF24_PA_MIN, RF24_PA_LOW, RF24_PA_HIGH, RF24_PA_MAX
#define Main_loop_iterations 500000                 // Snus är fint
...
uint16_t Msg_state; 
uint16_t Msg_time;
uint16_t NRF24_package[6] = {Msg_to_who, Msg_from_who, Msg_int, Msg_float, Msg_state, Msg_time};                        
